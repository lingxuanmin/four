...
//_icon.addClass("tipOK3");
                _icon.attr("class","tipIcon fl tipOK4");
                break;
            case 'info':
//_icon.addClass("tipInfo3");
                _icon.attr("class","tipIcon fl tipInfo4");
                break;
            case 'false':
//_icon.addClass("tipFalse3");
                _icon.attr("class","tipIcon fl tipFalse4");
                break;
            case 'help':
//_icon.addClass("tipHelp3");
                _icon.attr("class","tipIcon fl tipHelp4");
                break;
        };
        if(opts.msg){
